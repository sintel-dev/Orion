...
Python
~~~~~~
**Orion** has been tested on **GNU/Linux**, **macOS**, and **windows** systems running `Python 3.6, 3.7, 3.8, or 3.9`_ installed.
...
.. _Python 3.6, 3.7, 3.8, or 3.9: https://docs.python-guide.org/starting/installation/
